...
<div class="card">
    <form method="POST" action="<?php echo e(route('pengguna.store')); ?>" id="formPengguna">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <label class="role-option <?php echo e(old('role') === 'super_admin' ? 'selected-super' : ''); ?>" onclick="pilihRole('super_admin', this)">
                <input type="radio" name="role" value="super_admin" <?php echo e(old('role') === 'super_admin' ? 'checked' : ''); ?>>
            ...
            <label class="role-option <?php echo e(old('role') === 'admin' ? 'selected-admin' : ''); ?>" onclick="pilihRole('admin', this)">
            ...
            <label class="role-option <?php echo e(old('role') === 'guru' ? 'selected-guru' : ''); ?>" onclick="pilihRole('guru', this)">
                <input type="radio" name="role" value="guru" <?php echo e(old('role') === 'guru' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-presensi-guru\resources\views\pengguna\create.blade.php ENDPATH**/ ?>