...
<div class="login-wrap">
    <div class="login-card">
        <div class="login-header">
            <div class="school-logo-wrap">
                <img src="<?php echo e(asset('images/logo-sekolah.png')); ?>" alt="Logo MA Attaqwa" loading="lazy">
            </div>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input type="text" name="id_pengguna" value="<?php echo e(old('id_pengguna')); ?>"
    ...
    <div class="footer-info">
        &copy; <?php echo e(date('Y')); ?> MA Attaqwa — YPIA Daarul Mu'min &nbsp;|&nbsp; Sistem Presensi Guru
    </div>
</div>
<script>
function togglePass(){
...
<?php /**PATH C:\xampp\htdocs\laravel-presensi-guru\resources\views\auth\login.blade.php ENDPATH**/ ?>