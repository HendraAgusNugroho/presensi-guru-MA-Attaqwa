<?php $__env->startSection('title','Import Fingerprint'); ?>
...
<?php if(session('import_result')): ?>
    ...
    <div class="alert <?php echo e($result['berhasil'] > 0 ? 'alert-success' : 'alert-danger'); ?>" style="margin-bottom:18px">
        <i class="fas <?php echo e($result['berhasil'] > 0 ? 'fa-circle-check' : 'fa-triangle-exclamation'); ?> fa-lg"></i>
        <div>
            <strong>Hasil Import Fingerprint:</strong><br>
            <span style="font-size:.9rem">
                ✅ Berhasil diproses: <strong><?php echo e($result['berhasil']); ?></strong> data &nbsp;|&nbsp;
                ❌ Gagal: <strong><?php echo e($result['gagal']); ?></strong> data &nbsp;|&nbsp;
                ⚠️ Tidak ditemukan guru: <strong><?php echo e($result['tidak_ditemukan']); ?></strong>
            </span>
        </div>
    </div>
    ...
    <div class="card" style="border-left:4px solid #f59e0b;margin-bottom:18px">
        <div class="card-header" style="margin-bottom:10px;padding-bottom:8px">
            ...
            <span style="font-size:.8rem;color:#5a7a5a"><?php echo e(count($result['errors'])); ?> error</span>
        </div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
    ...
    <div class="card">
        ...
        <form method="POST" action="<?php echo e(route('fingerprint.proses')); ?>" enctype="multipart/form-data"
...
$message = $__bag->first($__errorArgs[0]); ?>
                <div class="alert alert-danger" style="margin-top:10px;padding:8px 12px;font-size:.85rem">
                    <i class="fas fa-triangle-exclamation"></i> <?php echo e($message); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="margin-top:14px">
            <a href="<?php echo e(route('fingerprint.index')); ?>" class="btn btn-secondary btn-sm">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-presensi-guru\resources\views\fingerprint\import.blade.php ENDPATH**/ ?>