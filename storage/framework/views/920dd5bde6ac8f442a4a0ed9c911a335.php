<?php $__env->startSection('title','Jadwal Guru Per Hari'); ?>
...
<div class="card">
    <form method="POST" action="<?php echo e(route('jadwal_guru.simpan')); ?>" id="formJadwal">
        <?php echo csrf_field(); ?>
        <div class="jadwal-table-wrap">
            <table class="jadwal-table">
                <thead>
                    <tr>
                        <th>Nama Guru</th>
                        <?php $__currentLoopData = $namaHari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kode => $nama): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <th class="hari-<?php echo e(strtolower($nama)); ?>">
                ...
                <?php $__currentLoopData = $gurus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        <td>
                            <div class="guru-name">
                                <span class="guru-no"><?php echo e($i + 1); ?>.</span>
                                <?php echo e($guru->nama); ?>

                            </div>
                            <div style="font-size:.72rem;color:#94a3b8;margin-top:2px">
                                ID: <?php echo e($guru->id_pengguna); ?> &nbsp;|&nbsp; <?php echo e($guru->barcode); ?>

                            </div>
                        </td>

                        <?php $__currentLoopData = $namaHari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kode => $namaH): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <td style="text-align:center">
                                <div class="time-input-wrap">
                                    <input type="time"
                                           name="jadwal[<?php echo e($guru->id); ?>][<?php echo e($kode); ?>][masuk]"
                                           class="time-input"
                                           value="<?php echo e($jamVal); ?>"
                                           placeholder="--:--"
                                           title="<?php echo e($namaH); ?> — <?php echo e($guru->nama); ?>">
                                </div>
                            </td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td style="text-align:center">
                            <button type="submit"
                                    class="btn-save-row"
                                    formaction="<?php echo e(route('jadwal_guru.simpan')); ?>"
                                    title="Simpan jadwal <?php echo e($guru->nama); ?>">
        ...
        <div style="display:flex;justify-content:flex-end;gap:10px;padding:16px 0 4px;border-top:1px solid #e8f5e9;margin-top:8px">
            <a href="<?php echo e(route('jadwal_guru.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-presensi-guru\resources\views\jadwal_guru\index.blade.php ENDPATH**/ ?>