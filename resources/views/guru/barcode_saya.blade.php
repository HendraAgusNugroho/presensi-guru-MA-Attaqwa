...
<div class="barcode-page">
    ...
    <div class="id-card">
        ...
        <div class="id-nama">{{ $guru->nama }}</div>
        <div class="id-nip">ID: {{ $guru->id_pengguna }}</div>
        <div class="id-jabatan">{{ $guru->jabatan }} &nbsp;·&nbsp; {{ $guru->mata_pelajaran ?? '-' }}</div>
    </div>
    ...
    <div class="barcode-box">
        ...
        <div id="qrCanvas"></div>
        <div class="barcode-text">{{ $guru->barcode }}</div>
    </div>
...
<div class="fullscreen-overlay" id="fsOverlay">
    ...
    <div id="qrFull"></div>
    <div class="fs-nama">{{ $guru->nama }}</div>
    <div class="fs-nip">ID: {{ $guru->id_pengguna }}</div>
...
<div id="printArea" style="display:none;">
    ...
    <div class="print-nama">{{ $guru->nama }}</div>
    <div class="print-nip">ID: {{ $guru->id_pengguna }}</div>
    <div class="print-jabatan">{{ $guru->jabatan }} — {{ $guru->mata_pelajaran ?? '-' }}</div>
    <div id="qrPrint"></div>
    <div class="print-barcode-text">{{ $guru->barcode }}</div>
...
<script>
const kodeQR = @json($guru->barcode);
const namaGuru = @json($guru->nama);
const nipGuru = @json("ID: " . $guru->id_pengguna);
const jabatanGuru = @json(($guru->jabatan ?? "Guru") . " 2014 " . ($guru->mata_pelajaran ?? "-"));
const barcodeText = @json($guru->barcode);
const idPengguna = @json($guru->id_pengguna);
