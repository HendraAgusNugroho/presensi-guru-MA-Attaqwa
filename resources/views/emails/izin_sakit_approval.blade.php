...
<head>
    ...
    <title>Notifikasi Pengajuan {{ ucfirst($presensi->status) }}</title>
    <style>
...
<div class="email-wrapper">
    ...
    <div class="email-header">
        <div class="logo-box">
            <img src="{{ $message->embed(public_path('images/logo-sekolah.png')) }}" alt="Logo MA Attaqwa">
        </div>
    ...
    @endphp
    <div class="status-banner {{ $approvalStatus }}">
        <div class="status-icon">{{ $isDisetujui ? '✅' : '❌' }}</div>
        <div class="status-title">
            Pengajuan {{ $statusLabel }} {{ $isDisetujui ? 'Disetujui' : 'Ditolak' }}
        </div>
    ...
    <div class="email-body">
        <div class="greeting">Assalamu'alaikum, {{ $namaGuru }}.</div>
        <p class="message-text">
            Kami ingin memberitahukan bahwa pengajuan <strong>{{ $statusLabel }}</strong> Anda
            untuk tanggal <strong>{{ $tanggalFormat }}</strong> telah diproses oleh admin.
        ...
        <div class="detail-card">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value">{{ $presensi->guru->id_pengguna ?? '-' }}</div>
            </div>
            <div class="detail-row">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value">
                    <span class="pill pill-{{ $presensi->status }}">{{ $statusLabel }}</span>
                </div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Keterangan</div>
                <div class="detail-value">{{ $presensi->keterangan ?: 'Tidak ada keterangan' }}</div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Status Keputusan</div>
                <div class="detail-value">
                    <span class="pill pill-{{ $approvalStatus }}">
                        {{ $isDisetujui ? 'Disetujui' : 'Ditolak' }}
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="info-box success">
            ...
            <div class="info-text">
                ...
                Presensi Anda untuk tanggal tersebut telah dicatat sebagai <strong>{{ $statusLabel }}</strong>.
